...
export default function MyAttendance() {
    ...
    return (
        <div className="max-w-[1200px] w-full animate-in fade-in zoom-in-95 duration-300 mx-auto bg-[#fafafa] min-h-screen p-6 -m-6 pb-24">
            <Breadcrumb items={[{ label: 'My Attendance' }]} homeLink="/admin/dashboard" />
            <div className="mb-6">
