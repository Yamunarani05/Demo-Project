...
const mapStageToStatus = (stage?: string): TaskStatus => {
      ...
      try {
        ...
        const mappedTasks: TaskItem[] = data.map(
          (task: any, index: number) => {
            ...
            let diffDays = -1;
            const status = mapStageToStatus(task.lead?.currentStage);
            
            if (task.dueDate && status === "ToDo") {
            ...
            return {
              ...
              leadSerialNumber: task.lead?.leadSerialNumber || String(task.lead?.leadId ?? ""),
              ...
              paginatedTasks.map((task) => (
                ...
                >
                  ...
                  <div className="col-span-1 flex justify-end">
                    <button
                      onClick={() => handleView(task.leadId)}
