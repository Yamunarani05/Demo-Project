...
className={cn(
  ...
  "before:content-[''] before:absolute before:inset-0 before:bg-violet-100 before:transition-all before:duration-500",
  "after:content-[''] after:absolute after:inset-[var(--hexagon-margin)] after:bg-violet-50",
  'after:[clip-path:polygon(50%_0%,_100%_25%,_100%_75%,_50%_100%,_0%_75%,_0%_25%)]',
  'hover:before:bg-violet-300 hover:after:bg-violet-100',
