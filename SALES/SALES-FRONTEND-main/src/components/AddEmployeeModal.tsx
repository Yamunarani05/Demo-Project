...
<div className="sticky top-0 bg-white border-b border-gray-200 px-4 py-3 rounded-t-2xl relative">
          <div>
            <h2 className="text-base font-bold text-gray-900">Add New Sales Employee</h2>
            <p className="text-xs text-gray-500 mt-0.5">Sales & CRM Operations Only · {getCurrentDate()}</p>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        >
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className="block text-xs font-medium mb-1">Sales Focus Domain<span className="text-red-500 ml-1">*</span></label>
                <select
                  value={formData.salesType}
                  onChange={e => handleChange('salesType', e.target.value)}
                  className="w-full px-2.5 py-1.5 border rounded-lg text-xs bg-white"
                >
                  <option value="Wedding & Event Sales">Wedding & Event Sales</option>
                  <option value="Commercial & Corporate Sales">Commercial & Corporate Sales</option>
                  <option value="Client Relationship & Lead Intake">Client Relationship & Lead Intake</option>
                  <option value="Promotions & Marketing">Promotions & Marketing</option>
                </select>{errors.salesType && <p className="text-red-500 text-[10px] mt-1">{errors.salesType}</p>}
              </div>

              <div>
                <label className="block text-xs font-medium mb-1">Sales Designation<span className="text-red-500 ml-1">*</span></label>
                <select
                ...
                >
                  ...
                  <option value="Telecaller / Lead Qualifier">Telecaller / Lead Qualifier</option>
                ...
                </select>{errors.position && <p className="text-red-500 text-[10px] mt-1">{errors.position}</p>}
              </div>
