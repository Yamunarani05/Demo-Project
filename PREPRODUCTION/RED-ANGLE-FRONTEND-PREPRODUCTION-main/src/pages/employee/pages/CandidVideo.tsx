...
export default function CandidVideo() {
    ...
    return (
        <div className="space-y-6 max-w-[1400px] mx-auto p-4 md:p-8 animate-in zoom-in-95 duration-300">
            <Breadcrumb items={[{ label: 'Candid Video Workspace' }]} homeLink="/employee/dashboard" />
            {!selectedProject ? (
                <>
                    <div>
