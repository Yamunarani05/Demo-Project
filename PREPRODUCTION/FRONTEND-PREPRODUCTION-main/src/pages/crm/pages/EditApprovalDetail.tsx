...
export default function CRMEditApprovalDetail() {
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        <button
          onClick={() => navigate('/crm/edit-approval')}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {cardTypes.map(type => {
          ...
          return (
            <div
              key={type}
              onClick={() => assignment && navigate(`/crm/edit-approval/${projectId}/${encodeURIComponent(type)}`)}
