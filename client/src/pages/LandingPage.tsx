...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col selection:bg-brand-500 selection:text-white relative overflow-hidden">
      {/* Animated gradient background */}
      <div className="absolute inset-0 background-animate opacity-20 pointer-events-none -z-10" />
      ...
      <motion.main className="flex-grow" initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.8, ease:'easeOut' }}>
        {/* Animate each section with a staggered fade-in */}
        <motion.div
          className="space-y-8"
          variants={fade}
          initial="hidden"
