...
export function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#040405] text-white flex flex-col selection:bg-purple-500 selection:text-white overflow-x-hidden">
      {/* Dynamic 3D Photo Ribbon & Lens Background */}
      <AnimatedBackground />

      {/* Interactive Camera Viewport Intro Overlay */}
      <AnimatePresence>
        {isCameraView && (
          <CameraViewport onEnterSite={() => setIsCameraView(false)} />
        )}
      </AnimatePresence>
