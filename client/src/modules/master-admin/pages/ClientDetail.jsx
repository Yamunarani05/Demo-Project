...
import { AlertCircle, ArrowLeft, Briefcase, CalendarDays, CheckCircle, Clock, FileText, IndianRupee, Mail, MapPin, Phone, UserRound, Users, Eye, Download, Camera } from 'lucide-react'
import { api } from '../api'
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
        ...
        <Link className="action-btn" to="/pre-production/client" style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
          <Camera size={15} />
          <span>Pre-production Pipeline →</span>
        </Link>
      </div>
